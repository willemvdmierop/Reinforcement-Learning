...
Original file is located at
    https://colab.research.google.com/drive/1sf4FAIMaDUDm9aED2uJhzjwi_NarWnHG
"""
"""
#SOURCES
...
print("\n This is Rainbow dueling noisy PER ! \n")
...
class Lunar_agent:
    ...
    def step(self, state, action, reward, next_state, done):
        ...
        if self.time_step == 0:
            ...
            if len(self.memory) > self.batch_size:
                ...
                self.train_Dueling_Noisy(experiences, self.gamma)
    ...
    def train_Dueling_Noisy(self, experiences, gamma):
...
print('\n', df.head())
df.to_csv("scores_Rainbow_Dueling_Noisy_PER.csv")
