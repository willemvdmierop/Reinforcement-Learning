...
class ReplayMemory(object):
    ...
    def __init__(self, action_size, capacity, batch_size, seed, prob_alpha=0.6):
    ...
    def sample(self, beta=0.4):
        ...
        # can initialize weights here or in train DQN
        # Below is wrong
        # weights = torch.from_numpy(np.vstack([e.weights for e in experiences if e is not None])).float.to(device)
        # correct:
...
print('\n', df.head())
df.to_csv("scores_Original_DQN_PER.csv")
